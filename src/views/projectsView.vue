...
const projectCardClass = 'animate-project-rise relative overflow-hidden rounded-xl border border-black/10 backdrop-blur-md bg-white/75 dark:bg-black/60 shadow-lg shadow-black/10 dark:shadow-black/40 transition-all duration-300 hover:border-black/18 dark:border-white/14 dark:hover:border-white/22'
