export const projects: object[] = [
  { 
    ...
    name: "Lesoll",
    category: "Live",
    desc: 'Built and maintained three major backend systems:Property API: Designed RESTful APIs to manage property listings, including draft, publishing, search filters and featured (Pinned and Repost Functionalities).Car API: Developed a separate API to manage car listings, brands, models, advanced search and package-based features.Admin Dashboard: Built a secure dashboard backend with role-based access control for managing users, listing ads, package and financial reporting.Built Real-time analytics views to monitor traffic and user behavior.Implemented tracking of user traffic sources by country, UTM parameters, and referral platforms (e.g., Google, Facebook, direct).Built a real-time chat system using Socket.io, enabling admin to communicate within the platform.',
    tags: [
      "Javascript",
      "TypeScript",
      "NoSQL",
