      ...
      <div max-w-4xl mx-auto min-h-screen text-black dark:text-white px-4 py-8>
        ...
        >
          <div p-8 md:p-12>
            ...
            <section mb-7>
              <h2
                class="text-sm font-bold text-gray-600 dark:text-gray-400 mb-2 uppercase tracking-widest"
              >
                Summary
              </h2>
            ...
            <section>
              ...
              <div class="space-y-1.5 text-sm text-gray-700 dark:text-gray-300">
                <p>
                  <span class="font-bold text-gray-900 dark:text-white">Backend:</span>
                ...
                <p>
                  <span class="font-bold text-gray-900 dark:text-white">Payments:</span>
                ...
                <p>
                  <span class="font-bold text-gray-900 dark:text-white">Frontend:</span>
