...
import type { BlogPost } from '../../shared/utils/blogs'
import { caseStudies, type CaseStudy } from '../../shared/utils/caseStudies'
...
export const staticCards: OgCard[] = [
  ...
  },
  {
    ...
    subtitle: 'Lesoll, EgyStay, SRVJ, Qars, 0Gosha, Gen-Import, Elrecord — backend, API, payment, cloud, and developer tooling.',
    footerLeft: author,
